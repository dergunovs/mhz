...
export declare const API_CATEGORY_POPULAR = "/category/popular";
...
export declare const API_MANUFACTURER_POPULAR = "/manufacturer/popular";
...
export declare const API_PRODUCT_POPULAR = "/product/popular";
...
export declare const API_UPLOAD_MULTIPLE = "/upload/multiple";
